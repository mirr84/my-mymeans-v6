...
const methods = {
    componentWillMount({dispatch}) {
        console.log('init Balans');
        dispatch.setter('layoutReducer', {title: 'График баланса', subTitle: ''});
    }
}
        ...
        <div>
            <Chart scale={cols} >
                ...
                <View data={averages} >
                    ...
                    <Geom type="point" position="time*temperature" size={4} shape='circle' style={{stroke: '#fff',lineWidth: 1,fillOpacity: 1}}/>
                </View>
            </Chart>
        </div>
    )
...
export default connector(lifecycle(methods)(Balans));
